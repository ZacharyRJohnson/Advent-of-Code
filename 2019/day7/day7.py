...
def main():
    ...
    inputSetting = 0
    values = []
    allPermutations = itertools.permutations(phaseSettings)
    for phase in allPermutations:
        inputSetting = 0
        for i in phase:
            inputSetting = ampCompute(memory, [i, inputSetting])
        values.append(inputSetting)
